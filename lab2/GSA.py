...
visited = set()
for nezavrsni_znak in nezavrsniZnakovi:
...
def odredi_kontekst_ntorke(ntorka):
    ...
    assert (produkcije_tuple[ntorka[0]][1][ntorka[1]] in nezavrsniZnakovi)  # nema smisla traziti kontekst ako ispred tocke nije nezavrsni znak
...
test = True
if test: # testovi za "gramatikaPrimjer.txt" iz uputa/materijala
