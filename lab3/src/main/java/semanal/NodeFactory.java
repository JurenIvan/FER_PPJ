...
public class NodeFactory {
    ...
    static {
        ...
        nodes.put(NodeType.DEKLARACIJA.symbolName, DeklaracijaParametra::new);
        nodes.put(NodeType.DEKLARACIJA_PARAMETRA.symbolName, Deklaracija::new);
        ...
        nodes.put(NodeType.IZRAZ.symbolName, IzrazNaredba::new);
        nodes.put(NodeType.IZRAZ_NAREDBA.symbolName, IzrazPridruzivanja::new);
        nodes.put(NodeType.IZRAZ_PRIDRUZIVANJA.symbolName, Izraz::new);
        ...
        nodes.put(NodeType.NAREDBA.symbolName, NaredbaGrananja::new);
        nodes.put(NodeType.NAREDBA_GRANANJA.symbolName, NaredbaPetlje::new);
        nodes.put(NodeType.NAREDBA_PETLJE.symbolName, NaredbaSkoka::new);
        nodes.put(NodeType.NAREDBA_SKOKA.symbolName, Naredba::new);
